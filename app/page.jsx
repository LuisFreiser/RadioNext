...
//   const maxRetries = 3;
//   const audioRef = useRef(null);
//   const [audioSource, setAudioSource] = useState(`/api/radio`);
//   const [hlsInstance, setHlsInstance] = useState(null);
//   const [currentImage, setCurrentImage] = useState(0);
//   const images = [
//     "/assets/slider1.jpg",
...
//       if (audio.paused) {
//         // Si el audio está en pausa, verificar si la fuente actual es correcta y la carga
//         if (audio.src !== streamUrl || !audio.src) {
//           audio.removeEventListener("canplay", () => handleCanPlay(audio));
//           audio.src = streamUrl;
//           audio.preload = "auto";
//           audio.crossOrigin = "anonymous";
...
//         }
//       } else {
//         // Si el audio está reproduciendo, pausarlo
//         audio.pause();
//         setIsPlaying(false);
//         setIsLoading(false);
//         setError(null);
...
//CODIGO ORIGINAL QUE realiza el llamado directo a la URL "http://82.145.41.50:26531/stream" del stream al reproductor, sin pasar por el endpoint de la API
"use client";
...
export default function Page() {
  ...
  const maxRetries = 3;
  const audioRef = useRef(null);
  const streamUrl = "http://yanapak.org:8000/svstudio";
  const [hlsInstance, setHlsInstance] = useState(null);
  const [currentImage, setCurrentImage] = useState(0);
  const images = [
    "/assets/slider1.jpg",
